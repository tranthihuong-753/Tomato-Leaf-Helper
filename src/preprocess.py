...
def reduce_dimensionality(features, n=50):
...
Shape đặc trưng HOG: (1776, 441) """
    ...
    # Bước 5: Lưu dữ liệu
    save_processed_data(x_train, y_train, "data/processed/train")
    save_processed_data(x_valid, y_valid, "data/processed/valid")
